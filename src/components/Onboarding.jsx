...
const SLIDES = [
  { emoji: '🌐', title: 'Your language', text: 'Littgram speaks your language. Change the app language and your feed language any time from Profile.' },
  { emoji: '📚', title: 'Discover books', text: 'Explore holds classics in Bengali, Hindi, Marathi and English. Tap any book for its story, chapters and quotes.' },
  { emoji: '🎧', title: '5-minute summaries', text: 'Short on time? Every book has a five-minute audio summary — tap Listen on the book page.' },
  { emoji: '📖', title: 'Read anywhere', text: 'The reader remembers your page, lets you bookmark, resize text, switch to English editions, and can read aloud to you.' },
  { emoji: '✒️', title: 'Share what moves you', text: 'Post quotes to the community feed, browse the quotes wall, and see what friends are reading.' },
  { emoji: '🏆', title: 'Reading challenges', text: 'Join monthly challenges and build your reading streak. Finish books to move the bar.' },
];
...
export default function Onboarding({ onDone }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 54, marginBottom: 22 }}>{slide.emoji}</div>
