...
const STRINGS = {
  en: {
    home: 'Home', explore: 'Explore', library: 'Library', comics: 'Comics', goals: 'Goals', profile: 'Profile',
    ...
    yourStory: 'Your story', uiLanguage: 'App language', nextRead: 'What to read next',
  },
  bn: {
    home: 'হোম', explore: 'অন্বেষণ', library: 'লাইব্রেরি', comics: 'কমিকস', goals: 'লক্ষ্য', profile: 'প্রোফাইল',
    ...
    yourStory: 'আপনার স্টোরি', uiLanguage: 'অ্যাপের ভাষা', nextRead: 'এরপর কী পড়বেন',
  },
  hi: {
    home: 'होम', explore: 'खोजें', library: 'पुस्तकालय', comics: 'कॉमिक्स', goals: 'लक्ष्य', profile: 'प्रोफ़ाइल',
    ...
    yourStory: 'आपकी स्टोरी', uiLanguage: 'ऐप की भाषा', nextRead: 'आगे क्या पढ़ें',
  },
  mr: {
    home: 'होम', explore: 'शोधा', library: 'ग्रंथालय', comics: 'कॉमिक्स', goals: 'ध्येय', profile: 'प्रोफाइल',
    ...
    yourStory: 'तुमची स्टोरी', uiLanguage: 'अ‍ॅपची भाषा', nextRead: 'पुढे काय वाचाल',
  },
};
